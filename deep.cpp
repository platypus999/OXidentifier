...
int main()
{
	...
	for (int i = 0; i < inputsize; ++i)
		for (int j = 0; j < hiddensize; ++j)
			cin >> network.W1.v(i, j);
	for (int i = 0; i < hiddensize; ++i)
		for (int j = 0; j < 1; ++j)
			cin >> network.b1.v(i, j);
	for (int i = 0; i < hiddensize; ++i)
		for (int j = 0; j < outputsize; ++j)
			cin >> network.W2.v(i, j);
	for (int i = 0; i < outputsize; ++i)
		for (int j = 0; j < 1; ++j)
			cin >> network.b2.v(i, j);
	string SS = "0000000000011000000001100001000011011000000111000000011100000011011100011000010000000000000000000000";
